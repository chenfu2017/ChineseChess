...
public class DefultSet {
    ...
    public static int canvasPosX = 420;
    public static int canvasPosY = 50;

    public static int menuX = 180;
    public static int menuY = 60;
    public static int menuP = 60;

    public static int menuWidth = 200;
    public static int menuHeight = 60;

    public static int infBoardX = 990;
    public static int infBoardY = 220;
    public static int infBoardWidth = 328;
    public static int infBoardHeight = 401;

    public static int timerLabelX = 1050;
