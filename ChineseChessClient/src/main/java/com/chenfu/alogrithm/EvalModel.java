...
public class EvalModel {
    ...
    public int eval(ChessBoard chessBoard, char player) {
        for (Map.Entry<String, ChessPiece> stringPieceEntry : chessBoard.stringChessPieceMap.entrySet()) {
            ...
            switch (chessPiece.character) {
                case 'b':
                    if (chessPiece.color == 'r') values[0][0] += evalPieceValue(0);
                    else values[1][0] += evalPieceValue(0);
                    break;
                case 's':
                    if (chessPiece.color == 'r') values[0][0] += evalPieceValue(1);
                    else values[1][0] += evalPieceValue(1);
                    break;
                case 'x':
                    if (chessPiece.color == 'r') values[0][0] += evalPieceValue(2);
                    else values[1][0] += evalPieceValue(2);
                    break;
                case 'm':
                    if (chessPiece.color == 'r') {
                        values[0][0] += evalPieceValue(3);
                        values[0][1] += evalPiecePosition(3, chessPiece.position);
                    } else {
                ...
                case 'j':
                    if (chessPiece.color == 'r') {
                        ...
                        values[0][1] += evalPiecePosition(4, chessPiece.position);
                    } else {
                ...
                case 'p':
                    if (chessPiece.color == 'r') {
                        ...
                        values[0][1] += evalPiecePosition(5, chessPiece.position);
                    } else {
                ...
                case 'z':
                    if (chessPiece.color == 'r') {
                        ...
                        values[0][1] += evalPiecePosition(6, chessPiece.position);
                    } else {
